	...
	return (
		<>
			...
			<Consulting1stepresultpage>
				...
				<H3>전문가 솔루션</H3>
				<P2>
					저와 비슷한 경험이 있으신 분이였어요. 저도 어릴 때 저의 피부 장벽이 무너진 줄 모르고 레이저며 시술이며 너무
					많이 받고 좋다는 고기능성 제품을 사용하다보니 더욱 더 예민해지며 트러블까지 일어났던 기억이 나네요. 가장 메인
					고민은, 어떻게 하면 피부가 건강해질까 이셨고 피부 건강을 위해서는 가장 먼저 피부 장벽을 강화하는 것이 중요하기
					때문에 피부 장벽을 튼튼하게 해줄 제품들로 구성해보았습니다.
				</P2>
				<Margin2 />
				<InputSet>
					<H3>아침 :</H3>
				...
				<InputSet>
					<P>
						<H>아이 메이크업 : </H>
						아이라인과 섀도우를 사용하여 눈을 강조하고, 눈썹을 정돈하여 얼굴의 균형을 맞추어줍니다. 황금빛이 도는
						브라운, 코랄, 오렌지 컬러의 아이섀도우를 사용하여 따뜻한 봄웜 톤을 강조합니다. 눈썹은 자연스러운 일자형
						눈썹과, 브러시를 사용하여 자연스러운 아이라인을 그립니다.
					</P>
				</InputSet>
				<Margin2 />
				<InputSet>
