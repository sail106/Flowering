  ...
  const question = [
      ...
      data: [
        ...
        },
        {
          ...
          items: [
            ...
            { text: "비누나 거품이 나는 클렌저를 사용하지 않습니다.\n(그 이유가 피부가 건조해져서 그렇다면 1번을 선택하십시오)", score: 2.5 },
          ],
        },
        {
      ...
      data: [
        ...
        },
        {
          ...
          items: [
            ...
            { text: "자주 그렇습니다.", score: 3 },
            { text: "항상 그렇습니다.", score: 4 },
            { text: "위와 같은 타입의 제품을 사용하지 않습니다\n(그 이유가 위의 현상 때문이라면 1번을 선택하십시오)", score: 2.5 },
          ],
        },
        {
        ...
        {
          questionTitle: "매운 음식이나 뜨거운 음식을 먹으면 피부가 붉어지거나 달 아오르는 느낌이 얼마나 자주 있습니까?",
          items: [
            { text: "결코 없습니다.", score: 1 },
            { text: "때때로 그렇습니다.", score: 2 },
            { text: "자주 그렇습니다.", score: 3 },
    ...
    },
    {
      ...
      data: [
        ...
        {
          questionTitle: "윗입술이나 양 볼에 어두운 부분이 있습니까? 또는 과거 있 었던 적이 있어 시술 등으로 제거했습니까?",
          items: [
            { text: "없습니다.", score: 1 },
    ...
    },
    {
      ...
      data: [
        ...
        {
          questionTitle: "살면서 흡연한 경험이 있습니까? 만약 흡연자라면 얼마나 자주 담배를 핍니까? 혹은 담배 피는 환경에 얼마나 자주 노출되어 있습니까?",
          items: [
            { text: "없습니다.", score: 1 },
